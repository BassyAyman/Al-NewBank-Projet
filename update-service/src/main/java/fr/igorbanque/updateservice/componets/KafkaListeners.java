...
public class KafkaListeners {
    ...
    void listenerOnTransaction(String transaction){
        ...
        try {
            ...
            //clientAccount.setAmountMoney(clientAccount.getAmountMoney() - transactionObj.getAmountOfTransaction()); former implementation
            clientAccount.setInDebitAmount(clientAccount.getInDebitAmount() + transactionObj.getAmountOfTransaction());
